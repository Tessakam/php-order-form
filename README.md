...
Should you use a COOKIE or a SESSION variable for this? ==> SESSION
...
-[x] To check if an input is a number you can use `is_numeric($number)`
...
- If you want to better understand sessions, go to the [php.net documentation](https://www.php.net/manual/en/features.sessions.php).
-[x] Do not use private browsing during this excersise, it will make it more difficult to get everything working.
